          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-1 gap-4">
            {[
              ...
              },
              {
                ...
                content: <div className="space-y-0.5"><p className="font-body text-on-surface font-medium text-lg">062 764 3270</p><p className="font-body text-on-surface-variant text-sm">079 574 5177</p></div>,
              },
              {
