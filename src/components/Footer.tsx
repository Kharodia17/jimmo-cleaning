      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-12 px-8 py-16 max-w-7xl mx-auto">
        ...
        <div className="space-y-6 md:col-span-1">
          ...
          <div className="flex items-center space-x-3">
            ...
            <span className="material-symbols-outlined text-[#007A87] cursor-pointer hover:opacity-80">public</span>
            <a href="mailto:info@jimmocleaning.co.za" className="material-symbols-outlined text-[#007A87] hover:opacity-80">mail</a>
          </div>
        </div>
        ...
        <div className="space-y-6">
          ...
          <nav className="flex flex-col space-y-3 font-label text-sm">
            <Link to="/about" className="text-slate-500 hover:text-[#009BAA] transition-colors">About Us</Link>
            <a href="#" className="text-slate-500 hover:text-[#009BAA] transition-colors">Careers</a>
            <a href="#" className="text-slate-500 hover:text-[#009BAA] transition-colors">Partners</a>
            <a href="#" className="text-slate-500 hover:text-[#009BAA] transition-colors">News &amp; Blog</a>
          </nav>
        </div>
        ...
        <div className="space-y-6">
          ...
          <nav className="flex flex-col space-y-3 font-label text-sm">
            <Link to="/services" className="text-slate-500 hover:text-[#009BAA] transition-colors">Commercial Cleaning</Link>
            <Link to="/services" className="text-slate-500 hover:text-[#009BAA] transition-colors">Industrial Facilities</Link>
            <Link to="/services" className="text-slate-500 hover:text-[#009BAA] transition-colors">Specialised Care</Link>
            <Link to="/contact" className="text-slate-500 hover:text-[#009BAA] transition-colors">Request a Quote</Link>
          </nav>
        </div>
        ...
        <div className="space-y-6">
          ...
          <nav className="flex flex-col space-y-3 font-label text-sm">
            <a href="#" className="text-slate-500 hover:text-[#009BAA] transition-colors">Privacy Policy</a>
            <a href="#" className="text-slate-500 hover:text-[#009BAA] transition-colors">Terms of Service</a>
            <a href="#" className="text-slate-500 hover:text-[#009BAA] transition-colors">POPIA Compliance</a>
            <a href="#" className="text-slate-500 hover:text-[#009BAA] transition-colors">FAQ</a>
          </nav>
        </div>
      </div>
